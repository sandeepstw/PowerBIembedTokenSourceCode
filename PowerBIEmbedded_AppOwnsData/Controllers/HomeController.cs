    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> EmbedReport(string username, string roles)
        {
            ...
            try
            {
               ...
               // ClientAssertion ca = new ClientAssertion("38c92faf-6cd2-4dc6-98aa-9f02f096c483", "qWvMMCQsJAkk+KsiHjRqWgp9Bn7nlVyOnD5rUM5B/G0=");
                
                //var authenticationResult = await authenticationContext.AcquireTokenAsync(ResourceUrl, ca);
